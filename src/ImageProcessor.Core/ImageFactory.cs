...
namespace ImageProcessor
{
    ...
    public class ImageFactory : IDisposable
    {
        ...
        public ImageFactory Mosaic(MosaicLayer mosaicLayer)
        {
            if (this.ShouldProcess && mosaicLayer != null)
            {
                var mosaic = new Mosaic { DynamicParameter = mosaicLayer };
                this.backupFormat.ApplyProcessor(mosaic.ProcessImage, this);
            }
            return this;
        }
